...
export const SurferCards = [
    {
        ...
        country: Aus,
        imageUrl: Surfer2, 
        description: "A passionate surfer with a deep connection to the ocean. Known for riding the biggest waves and pushing the limits of the sport. Embraces the thrill of the surf and the freedom of the sea.",
    },
    {
        name: "Daniel Johnson",
        age: 30,
    ...
    },
    {
        ...
        country: Prt,
        imageUrl: Surfer3, 
        description: "An emerging talent in the world of surfing, showcasing exceptional skills and style. This surfer's journey is just beginning, but their determination and natural talent make them a rising star in the surf community.",
    },
    {
        name: "Matheus Santos",
        age: 32,
        country: Bra,
        imageUrl: Surfer4, 
        description: "A seasoned surfer with years of experience in chasing waves around the globe. Embraces a holistic approach to surfing, connecting with nature and the ocean's energy in every ride.",
    }
